...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "go-bin-capstone-cc319e212459.json" # change for your GCP key
PROJECT = "go-bin-capstone" # change for your GCP project
